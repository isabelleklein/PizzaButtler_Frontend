...
function jsonErzeugen(){
	...
	jsonString = jsonString.concat("\"bild\": \"" + bild + "\",");
	jsonString = jsonString.concat("\"beschreibung\": \"" + beschreibung + "\",");
	jsonString = jsonString.concat("\"passwort\": \"123456\",");
	jsonString = jsonString.concat("\"wertung\":" + bewertung);
	jsonString = jsonString.concat("}");
	return jsonString;
}
...
function checkForm_Aendern()//Prüfung zum Ändern von Daten einer Pizzeria
{
	...
	var pruefungen = [name_piz_pruefen, strasse_piz_pruefen, hausnummer_piz_pruefen, plz_piz_pruefen, ort_piz_pruefen,
					  uhrzeit_piz_pruefen_start("sonntag_piz_aend", "fehlerSonntag_piz_aend"), uhrzeit_piz_pruefen("sonntag_piz_aend_bis", "fehlerSonntag_piz_aend"),
					  uhrzeit_piz_pruefen_start("montag_piz_aend", "fehlerMontag_piz_aend"), uhrzeit_piz_pruefen("montag_piz_aend_bis", "fehlerMontag_piz_aend"),
					  uhrzeit_piz_pruefen_start("dienstag_piz_aend", "fehlerDienstag_piz_aend"), uhrzeit_piz_pruefen("dienstag_piz_aend_bis", "fehlerDienstag_piz_aend"),
					  uhrzeit_piz_pruefen_start("mittwoch_piz_aend", "fehlerMittwoch_piz_aend"), ("mittwoch_piz_aend_bis", "fehlerMittwoch_piz_aend"),
					  uhrzeit_piz_pruefen_start("donnerstag_piz_aend", "fehlerDonnerstag_piz_aend"), uhrzeit_piz_pruefen("donnerstag_piz_aend_bis", "fehlerDonnerstag_piz_aend"),
					  uhrzeit_piz_pruefen_start("freitag_piz_aend", "fehlerFreitag_piz_aend"), uhrzeit_piz_pruefen("freitag_piz_aend_bis", "fehlerFreitag_piz_aend"),
					  uhrzeit_piz_pruefen_start("samstag_piz_aend", "fehlerSamstag_piz_aend"), uhrzeit_piz_pruefen("samstag_piz_aend_bis", "fehlerSamstag_piz_aend"),
	...
	return strFehler;
	**/
	return("" + name_piz_pruefen() + strasse_piz_pruefen() + hausnummer_piz_pruefen() + plz_piz_pruefen() + ort_piz_pruefen() +
			  uhrzeit_piz_pruefen_start("sonntag_piz_aend", "fehlerSonntag_piz_aend") + uhrzeit_piz_pruefen("sonntag_piz_aend_bis", "fehlerSonntag_piz_aend") +
			  uhrzeit_piz_pruefen_start("montag_piz_aend", "fehlerMontag_piz_aend") + uhrzeit_piz_pruefen("montag_piz_aend_bis", "fehlerMontag_piz_aend") +
			  uhrzeit_piz_pruefen_start("dienstag_piz_aend", "fehlerDienstag_piz_aend") + uhrzeit_piz_pruefen("dienstag_piz_aend_bis", "fehlerDienstag_piz_aend") +
			  uhrzeit_piz_pruefen_start("mittwoch_piz_aend", "fehlerMittwoch_piz_aend") + uhrzeit_piz_pruefen("mittwoch_piz_aend_bis", "fehlerMittwoch_piz_aend") +
			  uhrzeit_piz_pruefen_start("donnerstag_piz_aend", "fehlerDonnerstag_piz_aend") + uhrzeit_piz_pruefen("donnerstag_piz_aend_bis", "fehlerDonnerstag_piz_aend") +
			  uhrzeit_piz_pruefen_start("freitag_piz_aend", "fehlerFreitag_piz_aend") + uhrzeit_piz_pruefen("freitag_piz_aend_bis", "fehlerFreitag_piz_aend") +
			  uhrzeit_piz_pruefen_start("samstag_piz_aend", "fehlerSamstag_piz_aend") + uhrzeit_piz_pruefen("samstag_piz_aend_bis", "fehlerSamstag_piz_aend") +
			  telefonnummer_piz_pruefen() + mail_piz_pruefen());
...
function uhrzeit_piz_pruefen_start(tag, fehler_tag)
{
	var tage = '' + tag;
	var fehl = '' + fehler_tag;
	var zeit=document.getElementById(tage).value;
	  /**  Pruefung ob eine gueltige Mail-Adresse eingegeben wurde **/
    if(!new RegExp(/(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]/).test(zeit)){
...
function uhrzeit_piz_pruefen(tag, fehler_tag)
{
	...
	var zeit=document.getElementById(tage).value;
	  /**  Pruefung ob eine gueltige Mail-Adresse eingegeben wurde **/
    if(!(new RegExp(/(0[1-9]|1[0-9]|2[0-3]):[0-5][0-9]/).test(zeit)||new RegExp(/(0[0]):([0-5][1-9]|[1-5][0-9])/).test(zeit)||zeit=="24:00")){
  	    fehlerAusgeben(fehl, tage);
		return "Die Uhrzeit entspricht nicht der typischen Form einer Uhrzeit!\n";
  	}
    hinweisVerbergen(fehl, tage);
