...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		closeText: "Weiter", // Display text for close link
		prevText: "zurück", // Display text for previous month link
		nextText: "vor", // Display text for next month link
		currentText: "Aktueller", // Display text for current month link
		...
		dayNamesShort: ["Son", "Mon", "Din", "Mit", "Don", "Fre", "Sam"], // For formatting
