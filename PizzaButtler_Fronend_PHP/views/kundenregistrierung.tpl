<html>
    ...
    <body>
    	...
    	<a href="#" id="open">Eingabemaske Registrierung öffnen</a>
		<br/>
		<div id="container">
	        <form id='registrieren' name="registrieren" action="#">
	            ...
	            <label id="fehlerAnrede">Das Feld 'Anrede' ist nicht ausgewählt</label>
				
	            <div class="fline">
	                <input type="text" class="in2" name="vorname" id="vorname" placeholder="Vorname"  
	                required title="Zwischen 3 und 25 Zeichen (Umlaute möglich)" onchange="vornamePruefen()"></input>
	    
	                <input type="text" class="in2" type="text" name="nachname" id="nachname" placeholder="Nachname" 
	                 required title="3 bis 25 Zeichen (Umlaute möglich)" onchange="nachnamePruefen()"/>
	            </div>
	            <label id="fehlerName">Bitte geben Sie einen gültigen Nachnamen an</label>
	            <label id="fehlerVorname">Bitte geben Sie einen gültigen Vornamen an</label>
	            ...
	            <label id="fehlerDat">Bitte geben Sie einen gültiges Datum an</label>
	            <div class="fline">
	            ...
	            <label id="fehlerStrasse">Bitte geben Sie eine gültige Strasse an</label>
	            <label id="fehlerHnr">Bitte geben Sie eine gültige Hausnummer an</label>
	            ...
	            <label id="fehlerPlz">Bitte geben Sie eine gültige Postleitzahl an</label>
	            <label id="fehlerOrt">Bitte geben Sie einen gültigen Ort an</label>
	            ...
	            <label id="fehlerEmail">Bitte geben Sie eine gültige Email-Adresse an</label>
	            <label id="fehlerTel">Bitte geben Sie eine gültige Telefonnummer an</label>
	
	            <div class="fline">
	                <input class="in2" type="password" name="passwort" placeholder="Passwort" id="passwort" required title="Mindestens eine Ziffer, ein Großbuchstabe, ein Kleinbuchstabe und insgesamt 8 Zeichen" 
	            ...
	            <label id="fehlerPw_2">Die Passwörter stimmen nicht überein</label>
	            <div class="fline">
	            ...
	            <p>
	                <input id="absenden" name="absenden" type="button" value="Kundenregistrierung abschließen"/>
	            </p>
